...
exports.NUMERIC_DATATYPES = exports.QCR = exports.PROV = exports.CDT = exports.CDT_QUANTITY_DATATYPE_NAMES = exports.QUDT = exports.SH = exports.XSD = exports.RDF = void 0;
exports.RDF = {
...
exports.CDT_QUANTITY_DATATYPE_NAMES = [
    'ucum',
    'acceleration',
    'amountOfSubstance',
    'angle',
...
exports.CDT = {
    ...
    quantityDatatypeNames: exports.CDT_QUANTITY_DATATYPE_NAMES,
    supported: new Set([CDT_NAMESPACE, CDT_SHORT_NAMESPACE].flatMap((namespace) => exports.CDT_QUANTITY_DATATYPE_NAMES.map((name) => `${namespace}${name}`))),
};
exports.PROV = {
